...
namespace NickPixPlus.Controllers
{
    public class ProductModelsController : Controller
    {
        ...
        public ProductModelsController(NickPixPlusContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ProductDb != null ? 
                          ...
                          Problem("Entity set 'NickPixPlusContext.ProductDb'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,ProductDescription,ProductImage,TrailerURL,ProductPrice")] ProductModel productModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,ProductName,ProductDescription,ProductImage,TrailerURL,ProductPrice")] ProductModel productModel)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NickPixPlusContext.ProductDb'  is null.");
            }
            var productModel = await _context.ProductDb.FindAsync(id);
            if (productModel != null)
            {
